...
Revision ID: c0263f9526f2
Revises: 
Create Date: 2023-07-02 14:53:42.334165
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_users_password'), 'users',
    ...
    op.create_index(op.f('ix_rundates_date'),
                    'rundates', ['date'], unique=False)
    op.create_index(op.f('ix_rundates_id'), 'rundates', ['id'], unique=False)
    op.create_index(op.f('ix_rundates_task_id'),
                    'rundates', ['task_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_rundates_date'), table_name='rundates')
